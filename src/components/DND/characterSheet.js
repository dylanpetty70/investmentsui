              ...
              temp.push(
                 <Row key={Object.keys(this.state.customAttacks)[i]} style={{marginBottom: '20px'}}>
                    <Form inline='true'>
                        ...
                        <Form.Control style={{width: '25%', marginRight: '20px'}} placeholder={this.state.customAttacks[Object.keys(this.state.customAttacks)[i]].attack} onChange={(text) =>{this.setState({...this.state, customAttacks: {...this.customAttacks, [Object.keys(this.state.customAttacks)[i]]: {...this.customAttacks[Object.keys(this.state.customAttacks)[i]], attack: text.target.value}}})}}/>
                        <Form.Control style={{width: '25%'}} placeholder={this.state.customAttacks[Object.keys(this.state.customAttacks)[i]].damage} onChange={(text) =>{this.setState({...this.state, customAttacks: {...this.customAttacks, [Object.keys(this.state.customAttacks)[i]]: {...this.customAttacks[Object.keys(this.state.customAttacks)[i]], damage: text.target.value}}})}}/>
