            ...
            return(
                ...
                <Modal.Body>
                    <Form className="container">
                      ...
                      <Form.Group controlId="formBasicPassword">
                        <Form.Label>Password to Create User</Form.Label>
                        <Form.Control type="password" placeholder="Get Password From Dylan" onChange={(text) => {this.setState({...this.state, newPasswordCheck: text.target.value})}}/>
                      </Form.Group>
                    </Form>
                </Modal.Body>
                <Modal.Footer>
                    <Button variant="primary" onClick={() => {this.setState({showNew: false, show: true}); this.props.handleNewUser(this.state.newUsername, this.state.newFirstName, this.state.newLastName, this.state.newPassword, this.state.newPasswordCheck);}}>
                        Create New User
                    </Button>
